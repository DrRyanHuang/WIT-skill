...
WIT 的使用方式很简单：**先让 AI 读取 `WIT-科学思考与写作工作流.md`，再要求它按照 WIT 分析当前研究问题或论文。**

#### 在 ChatGPT 中

把 `WIT-科学思考与写作工作流.md` 上传到当前对话，然后说：
...
把 `WIT-科学思考与写作工作流.md` 放进对应项目或 Work 的资料中，然后在开始任务时说：

> 请先读取 WIT-科学思考与写作工作流.md，并把它作为本项目的研究与写作规则。
...
> Read `WIT-科学思考与写作工作流.md` first, and use it as the research-thinking and scientific-writing workflow for this project.

如果工具支持项目级 instruction，也可以在项目说明中加入：

> Before analyzing research questions, results, or manuscript text, read and follow `WIT-科学思考与写作工作流.md`.
...
# 十一、E — Examine the Literature：审视文献
...
# 十一、I — Interrogate the Finding：追问发现
...
# 十一、T — Test Answerability：检验可回答性
...
# 十一、Results 应按 Scientific Question 组织，而不是按技术组织
...
# 十一、Discussion Opening：1-hop → 2-hop
...
# 十一、Discussion Middle：2-hop → General Principle
...
# 二十一、从 General Principle 向外展开 Question Space
...
# 二十一、Future Studies 应从 Limitation 推导
...
# 二十一、Reviewer Stress Test：审稿人压力测试
...
# 二十一、新手模式：Results Subsection 填空模板
...
# 二十一、Research Depth Diagnostic：科研深度诊断
...
> 这是我的核心 idea：XXX。请按 WIT 帮我设计 research storyline。
...
检查每个 subsection 是否由 scientific question 驱动、是否只是按技术组织、是否存在明确 finding 和合适的 1-hop opinion、是否有本来可以回答的问题被过早扔进 Discussion、是否存在未处理的异常结果，以及是否遗漏关键 control / alternative explanation。

## 模式 4：检查 Discussion

> 请按 WIT 检查 Discussion。
...
> Deadline 很近，请按 WIT 的 Deadline Mode 帮我收束。
